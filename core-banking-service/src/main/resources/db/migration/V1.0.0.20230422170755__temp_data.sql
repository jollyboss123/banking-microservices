...
VALUES ('1', 'sam@gmail.com', 'Sam', '988829932V', 'Gracia');
INSERT INTO banking_core_service.banking_core_user (id, email, first_name, identification_number, last_name)
VALUES ('2', 'stanley@gmail.com', 'Stanley', '921830556V', 'Jackson');
INSERT INTO banking_core_service.banking_core_user (id, email, first_name, identification_number, last_name)
VALUES ('3', 'grace@gmail.com', 'Grace', '368829932V', 'Fan');
INSERT INTO banking_core_service.banking_core_user (id, email, first_name, identification_number, last_name)
VALUES ('4', 'adam@gmail.com', 'Adam', '872829932V', 'Sandler');
